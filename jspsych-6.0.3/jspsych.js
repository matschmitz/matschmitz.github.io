        ...
        var interval = setInterval(function(){
          ...
          if(w < mw || h < mh){
            var msg = '<p>Your browser window is too small to complete this experiment. '+
              'Please press try to press <span class="light-keys"><kbd>F11</kbd></span> to maximize the size of your browser window. If your browser window is already maximized, '+

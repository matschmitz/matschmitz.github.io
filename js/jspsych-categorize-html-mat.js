...
jsPsych.plugins['categorize-html'] = (function() {
  ...
  plugin.info = {
    ...
    parameters: {
      ...
      correct_text_duration: {
        type: jsPsych.plugins.parameterType.BOOL,
        pretty_name: 'Display or not correct_text',
        default: 1500,
        description: 'If true, the correct_text will be displayed'
      },
      incorrect_text: {
        type: jsPsych.plugins.parameterType.STRING,
  ...
  plugin.trial = function(display_element, trial) {
    ...
    function doFeedback(correct, timeout) {
      ...
      if (trial.force_correct_button_press && correct === false && ((timeout && trial.show_feedback_on_timeout) || !timeout)) {
        ...
        if(correct == true) {trial.feedback_duration = trial.correct_text_duration};
        jsPsych.pluginAPI.setTimeout(function() {
          endTrial();

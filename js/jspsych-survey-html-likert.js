 ...
 */
 ...
 jsPsych.plugins['survey-likert'] = (function() {
  ...
  plugin.info = {
    ...
    html += ".jspsych-survey-likert-statement { display:block; font-size: 16px; padding-top: 10px; margin-bottom:10px; }"+
    ".jspsych-survey-likert-opts { list-style:none; width:100%; margin:0; padding:0 0 10px; display:block; font-size: 14px; line-height:1.1em; }"+
